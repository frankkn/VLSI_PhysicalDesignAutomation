...
class AbacusLegalizer
{
	...
	void addVirtualCell1(Cell *cell, Cluster *cluster, double x_final, Subrow *subrow);
	void addVirtualCell2(Cell *cell, Cluster *cluster, double x_final, Subrow *subrow);
